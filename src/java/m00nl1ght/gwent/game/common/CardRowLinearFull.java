...
public class CardRowLinearFull extends CardRowLinear {

	public CardRowLinearFull(GuiContainer<? extends GuiElement> base, ElementPos position, CardLocation location, boolean mutable) {
