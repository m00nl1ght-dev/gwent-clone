package m00nl1ght.voidUI.opengl;
...
public class ShaderProgram {
	...
	public ShaderProgram(String vertexShaderLoc, String fragShaderLoc, List<VertexAttrib> attribLocations) throws Exception {
		String vertexShaderSource = readFileAsString(vertexShaderLoc);
		String fragShaderSource = readFileAsString(fragShaderLoc);
	 ...
	 * @throws Exception 
	 * @throws IllegalArgumentException if there was an issue */
	public ShaderProgram(String vertexShaderSource, String fragShaderSource) throws Exception {
	...
	private void fetchUniforms() {
		...
		int strLen = 64; //glGetProgrami(program, GL_ACTIVE_UNIFORM_MAX_LENGTH); // bug, chrashes
		for (int i = 0; i < len; i++) {
