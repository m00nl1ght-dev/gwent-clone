...
public class Image implements Renderable {
	...
	/** The x pos (in range 0F to 1F) of the centre of rotation */
    protected float centerX; 
    /** The y pos (in range 0F to 1F) of the centre of rotation */
    ...
    //private boolean flipped; not implemented anyway
    /** The transparent colour set if any */
    //private Color transparent; not implemented anyway
	 ...
	 * 
	 * @param ref The location of the image file to load
	 * @param !!! not implemented !!! flipped True if the image should be flipped on the y-axis on load
	 * @throws SlickException Indicates a failure to load the image
	 */
	 ...
	 * @param !!! not implemented !!! transparent The color to treat as transparent
	 * @throws SlickException Indicates a failure to load the image
	 */
	 ...
	 * 
	 * @param x The x pos (0f - 1f) of center of rotation relative to the width/height of the image
	 * @param y The y pos (0f - 1f) of center of rotation relative to the width/height of the image
	 */
	...
	public void draw(float x, float y, float x2, float y2, float srcx, float srcy, float srcx2, float srcy2, Color filter) {
		...
		filter.bind();
		texture.bind();
		float cX = (x2-x)*centerX;
    	float cY = (y2-y)*centerY;
...
//		GL.glEnd();
	...
	public void drawWarped(float x1, float y1, float x2, float y2, float x3, float y3, float x4, float y4) {
        Color.white.bind();
        texture.bind();
        float cX = (x2-x1+x3-x4)/2*centerX;
    	float cY = (y2-y1+y3-y4)/2*centerY;
