 ...
 * 
 * @author Kevin Glass, edited: m00nl1ght
 */
public class Color implements Serializable {
    ...
    /** A float multiplier applied to all colors alpha values for global GUI layer blending */
    protected static float blend = 1F;
	...
	public float a() {return a*blend;}
	public float aa() {return a;}
	public void r(float f) {this.r=f;}
	public void g(float f) {this.g=f;}
	public void b(float f) {this.b=f;}
	public void a(float f) {this.a=f;}
	...
	/**
	 * Set the global blend factor of all colors.
	 * It is applied to the alpha of all colors when drawn or retrieved.
	 * Use resetBlendFactor() to disable it.
	 * 
	 * @param f the blend factor
	 */
	public static void setBlendFactor(float f) {
		blend=Math.min(1F, Math.max(0F, f));
	}
	
	/**
	 * Set the blend factor of all colors.
	 * [edit by m00nl1ght]
	 */
	public static void setBlendFactor(float f1, float f2) {
		blend=Math.min(1F, Math.max(0F, f1)) * Math.min(1F, Math.max(0F, f2));
	}
	
	/**
	 * Reset the blend factor of all colors to 1F.
	 * [edit by m00nl1ght]
	 */
	public static void resetBlendFactor() {
		blend=1F;
	}
	 ...
	 */
	public void bind() {
		GL.glColor4f(r,g,b,a*blend);
	}
	
	/**
	 * Bind this colour to the GL context without taking global blend factor into account
	 */
	public void bindAware() {
