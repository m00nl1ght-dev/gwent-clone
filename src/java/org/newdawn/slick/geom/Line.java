...
public class Line extends Shape {
	...
	private static final long serialVersionUID = -1026425276458066752L;
	...
	/** Temporary storage - declared globally to reduce GC */
	protected Vector2f v2 = new Vector2f(0, 0);
	/** Temporary storage - declared globally to reduce GC */
	protected Vector2f proj = new Vector2f(0, 0);

	/** Temporary storage - declared globally to reduce GC */
	protected Vector2f closest = new Vector2f(0, 0);
	/** Temporary storage - declared globally to reduce GC */
	protected Vector2f other = new Vector2f(0, 0);

	/** True if this line blocks on the outer edge */
	protected boolean outerEdge = true;
	/** True if this line blocks on the inner edge */
	protected boolean innerEdge = true;
